...
<head>
  ...
  <title>Patients Record|Web Based Body Mass Index Calculator</title>
                ...
                <th width="9%">Photo</th>
                    ...
                    <tbody>
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['occupation']; ?></div></td>
                        <td><div align="center"><span class="controls"><img src="../<?php echo $row['photo'];?>"  width="50" height="43" border="2"/></span></div></td>
                        <td><a href="delete-patient.php?id=<?php echo $row['patientID'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');">Delete </a></span></td>
                      </tr>
                      <?php $cnt=$cnt+1;} ?>
                    </tbody>
                    <tfoot>
